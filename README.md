...
| **11–12** | "Build me a website." 24 hours later, [sanwan.ai](https://sanwan.ai) is live. Cost: $115. |
...
- **[OpenClaw](https://github.com/openclaw/openclaw)** — the open-source AI agent framework powering Sanwan
...
- **[36Kr](https://36kr.com)** — China's leading tech publication
- **[South China Morning Post](https://www.scmp.com)** — Asia's leading English-language newspaper
- **[Zhihu](https://zhihu.com)** — trending in AI & startup communities (China's Quora)
- **[Phoenix News](https://tech.ifeng.com)** — national tech coverage
- **[53AI](https://53ai.com)** — deep-dive on the agent architecture
...
**If this resonates with you** — whether you're a founder, a builder, or just curious about where AI agents are headed — star this repo, visit [sanwan.ai](https://sanwan.ai), or reach out on X. I'd love to hear your story too.
